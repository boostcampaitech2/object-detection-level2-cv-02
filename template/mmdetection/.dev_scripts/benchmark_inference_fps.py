...
def parse_args():
    ...
    parser.add_argument("--max-iter", type=int, default=400, help="num of max iter")
    parser.add_argument("--log-interval", type=int, default=40, help="interval of logging")
    parser.add_argument(
        "--fuse-conv-bn",
        action="store_true",
...
if __name__ == "__main__":
    ...
    for model_key in config:
        ...
        for model_info in model_infos:
            ...
            try:
                fps = measure_inferense_speed(cfg, checkpoint, args.max_iter, args.log_interval, args.fuse_conv_bn)
                print(
