...
def main():
    ...
    assert args.out or args.run, (
        "Please specify at least one operation (save/run/ the " 'script) with the argument "--out" or "--run"'
    )
    ...
    with open(args.txt_path, "r") as f:
        ...
        for i, cfg in enumerate(model_cfgs):
            ...
            if max_keep_ckpts:
                command_info += f"--cfg-options " f"checkpoint_config.max_keep_ckpts=" f"{max_keep_ckpts}" + " "
