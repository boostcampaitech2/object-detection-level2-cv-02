...
def parse_args():
    ...
    parser.add_argument(
        "--data-pipeline", action="store_true", help="to train models related to data pipeline, e.g. augmentations"
    )
    ...
    parser.add_argument(
        "--out", type=str, default="batch_train_list.txt", help="output path of gathered metrics to be stored"
    )
