...
from mmdet.datasets import ClassBalancedDataset, ConcatDataset, CustomDataset, MultiImageMixDataset, RepeatDataset
...
def test_dataset_wrapper():
    ...
    multi_image_mix_dataset = MultiImageMixDataset(dataset_a, pipeline, dynamic_scale)
    ...
    multi_image_mix_dataset = MultiImageMixDataset(
        dataset_a, pipeline, dynamic_scale, skip_type_keys=("MixUp", "RandomFlip", "Resize", "Pad")
    )
    for idx in range(len_a):
        results_ = multi_image_mix_dataset[idx]
