...
class CustomDatasetTests(unittest.TestCase):
    ...
    def test_data_infos__default_db_directories(self):
        ...
        custom_ds = self.dataset_class(
            ...
            ann_file=os.path.join(test_dataset_root, "ImageSets", "Main", "trainval.txt"),
            pipeline=[],
            classes=("person", "dog"),
            test_mode=True,
        )
        ...
        self.assertListEqual(
            [{"id": "000001", "filename": "JPEGImages/000001.jpg", "width": 353, "height": 500}], custom_ds.data_infos
        )
    ...
    def test_data_infos__overridden_db_subdirectories(self):
        ...
        self.assertListEqual(
            [{"id": "000001", "filename": "images/000001.jpg", "width": 353, "height": 500}], custom_ds.data_infos
        )
