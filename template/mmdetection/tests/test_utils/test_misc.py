...
def test_distance2bbox():
    ...
    distance = torch.Tensor(
        [[0.0, 0, 1.0, 1.0], [1.0, 2.0, 10.0, 6.0], [22.0, -29.0, 138.0, 61.0], [54.0, -29.0, 170.0, 61.0]]
    )
    expected_decode_bboxes = torch.Tensor(
        [[74.0, 61.0, 75.0, 62.0], [0.0, 104.0, 0.0, 112.0], [100.0, 90.0, 100.0, 120.0], [0.0, 120.0, 100.0, 120.0]]
    )
