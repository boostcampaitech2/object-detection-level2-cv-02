...
def test_retinanet_head_get_bboxes():
    ...
    retina_model.get_bboxes = partial(retina_model.get_bboxes, img_metas=img_metas, with_nms=False)
...
def test_yolov3_head_get_bboxes():
    ...
    yolo_model.get_bboxes = partial(yolo_model.get_bboxes, img_metas=img_metas, with_nms=False)
...
def test_fcos_head_get_bboxes():
    ...
    fcos_model.get_bboxes = partial(fcos_model.get_bboxes, img_metas=img_metas, with_nms=False)
...
def test_fsaf_head_get_bboxes():
    ...
    fsaf_model.get_bboxes = partial(fsaf_model.get_bboxes, img_metas=img_metas, with_nms=False)
...
def ssd_config():
    ...
    test_cfg = mmcv.Config(
        dict(
            deploy_nms_pre=0, nms=dict(type="nms", iou_threshold=0.45), min_bbox_size=0, score_thr=0.02, max_per_img=200
        )
    )
...
def test_ssd_head_get_bboxes():
    ...
    ssd_model.get_bboxes = partial(ssd_model.get_bboxes, img_metas=img_metas, with_nms=False)
