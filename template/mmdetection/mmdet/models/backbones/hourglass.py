...
class HourglassModule(BaseModule):
    ...
    def __init__(
        ...
        self.low3 = ResLayer(
            BasicBlock, next_channel, cur_channel, cur_block, norm_cfg=norm_cfg, downsample_first=False
        )
...
class HourglassNet(BaseModule):
    ...
    def __init__(
        ...
        self.stem = nn.Sequential(
            ...
            ResLayer(BasicBlock, cur_channel // 2, cur_channel, 1, stride=2, norm_cfg=norm_cfg),
        )
