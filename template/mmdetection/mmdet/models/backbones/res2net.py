...
class Bottle2neck(_Bottleneck):
    ...
    def __init__(self, inplanes, planes, scales=4, base_width=26, base_channels=64, stage_type="normal", **kwargs):
        ...
        self.conv1 = build_conv_layer(
            self.conv_cfg, self.inplanes, width * scales, kernel_size=1, stride=self.conv1_stride, bias=False
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(Res2Net, self).__init__(
            style="pytorch", deep_stem=True, avg_down=True, pretrained=pretrained, init_cfg=init_cfg, **kwargs
        )
