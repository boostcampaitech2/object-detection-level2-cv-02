...
class ASPP(BaseModule):
    ...
    def __init__(
        self, in_channels, out_channels, dilations=(1, 3, 6, 1), init_cfg=dict(type="Kaiming", layer="Conv2d")
    ):
...
class RFP(FPN):
    ...
    def __init__(
        self, rfp_steps, rfp_backbone, aspp_out_channels, aspp_dilations=(1, 3, 6, 1), init_cfg=None, **kwargs
    ):
