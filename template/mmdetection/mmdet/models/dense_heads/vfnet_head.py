...
class VFNetHead(ATSSHead, FCOSHead):
    ...
    @force_fp32(apply_to=("cls_scores", "bbox_preds", "bbox_preds_refine"))
    def get_bboxes(self, cls_scores, bbox_preds, bbox_preds_refine, img_metas, cfg=None, rescale=None, with_nms=True):
        ...
        for img_id in range(len(img_metas)):
            ...
            det_bboxes = self._get_bboxes_single(
                cls_score_list, bbox_pred_list, mlvl_points, img_shape, scale_factor, cfg, rescale, with_nms
            )
    ...
    def _get_bboxes_single(
        ...
        for cls_score, bbox_pred, points in zip(cls_scores, bbox_preds, mlvl_points):
            ...
            scores = cls_score.permute(1, 2, 0).reshape(-1, self.cls_out_channels).contiguous().sigmoid()
