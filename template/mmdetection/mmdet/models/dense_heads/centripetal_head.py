...
class CentripetalHead(CornerHead):
    ...
    def _init_centripetal_layers(self):
        ...
        for _ in range(self.num_feat_levels):
            ...
            self.tl_guiding_shift.append(
                self._make_layers(out_channels=self.guiding_shift_channels, in_channels=self.in_channels)
            )
            ...
            self.tl_centripetal_shift.append(
                self._make_layers(out_channels=self.centripetal_shift_channels, in_channels=self.in_channels)
            )
    ...
    def loss(
        ...
        loss_dict = dict(
            det_loss=det_losses, off_loss=off_losses, guiding_loss=guiding_losses, centripetal_loss=centripetal_losses
        )
        return loss_dict
