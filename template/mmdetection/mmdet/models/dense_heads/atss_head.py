...
class ATSSHead(AnchorHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(ATSSHead, self).__init__(num_classes, in_channels, init_cfg=init_cfg, **kwargs)
    ...
    def loss_single(
        self, anchors, cls_score, bbox_pred, centerness, labels, label_weights, bbox_targets, num_total_samples
    ):
