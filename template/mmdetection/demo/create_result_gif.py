...
def parse_args():
    ...
    parser.add_argument(
        "image_dir", help="directory where result " "images save path generated by ‘analyze_results.py’"
    )
...
def create_frame_by_matplotlib(image_dir, nrows=1, fig_size=(300, 300), font_size=15):
    ...
    for paths in _generate_batch_data(zip(*images_list), nrows):
        ...
        plt.legend(handles=[det_patch, gt_patch], bbox_to_anchor=(1, -0.18), loc="lower right", borderaxespad=0.0)
