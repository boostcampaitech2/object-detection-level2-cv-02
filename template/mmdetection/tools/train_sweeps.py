...
from custom_parser_tool import get_opt_name, _update_config


def set_custom_parser(args):
    ...
    cfg = _update_config(cfg, modification)
...
def parse_args():
    ...
    args, cfg = set_custom_parser(parser)
