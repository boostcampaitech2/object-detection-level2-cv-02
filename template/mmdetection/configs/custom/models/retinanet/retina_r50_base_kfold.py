# python tools/train.py configs/custom/models/retinanet/retina_r50_base_kfold.py
# python tools/train_cv.py configs/custom/models/retinanet/retina_r50_base_kfold.py

# python tools/inference.py configs/custom/models/retinanet/retina_r50_base_kfold.py work_dirs/retinanet --epoch best_bbox_mAP_50_epoch_14
