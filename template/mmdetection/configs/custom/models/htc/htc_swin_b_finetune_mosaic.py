# python tools/train.py configs/custom/models/htc/htc_swin_b_finetune_mosaic.py
# python tools/inference.py configs/custom/models/htc/htc_swin_b_finetune_mosaic.py --epoch best_bbox_mAP_50_epoch_17
...
# load_from = "work_dirs/htc_swin_b/best_bbox_mAP_50_epoch_13.pth"
# resume_from = "work_dirs/htc_swin_b_finetune_mosaic/latest.pth"
...
exp = "htc_swin_b_finetune_mosaic"
