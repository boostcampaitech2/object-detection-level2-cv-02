...
model = dict(
    rpn_head=dict(
        ...
        stages=[
            dict(
                ...
                bbox_coder=dict(
                    type="DeltaXYWHBBoxCoder", target_means=(0.0, 0.0, 0.0, 0.0), target_stds=(0.1, 0.1, 0.5, 0.5)
                ),
    ...
    train_cfg=dict(
        rpn=[
            ...
            dict(
                assigner=dict(
                    type="MaxIoUAssigner", pos_iou_thr=0.7, neg_iou_thr=0.7, min_pos_iou=0.3, ignore_iof_thr=-1
                ),
