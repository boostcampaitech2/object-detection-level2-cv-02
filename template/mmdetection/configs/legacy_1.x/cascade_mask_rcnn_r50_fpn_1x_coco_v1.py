...
model = dict(
    ...
    rpn_head=dict(
        ...
        bbox_coder=dict(
            type="LegacyDeltaXYWHBBoxCoder", target_means=[0.0, 0.0, 0.0, 0.0], target_stds=[1.0, 1.0, 1.0, 1.0]
        ),
    ),
    roi_head=dict(
        ...
        bbox_head=[
            dict(
                ...
                num_classes=80,
                bbox_coder=dict(
                    type="LegacyDeltaXYWHBBoxCoder", target_means=[0.0, 0.0, 0.0, 0.0], target_stds=[0.1, 0.1, 0.2, 0.2]
                ),
            ),
            dict(
                type="Shared2FCBBoxHead",
