...
train_pipeline = [
    ...
    dict(type="Resize", img_scale=[(320, 320), (416, 416)], multiscale_mode="range", keep_ratio=True),
...
# learning policy
lr_config = dict(policy="step", warmup="linear", warmup_iters=4000, warmup_ratio=0.0001, step=[24, 28])
# runtime settings
