...
class FastRCNNOutputs:
    ...
    def __init__(
        ...
        if len(proposals):
            ...
            if proposals[0].has("gt_classes"):
                ...
                gt_boxes = [p.gt_boxes if p.has("gt_boxes") else p.proposal_boxes for p in proposals]
    ...
    def box_reg_loss(self):
        ...
        if cls_agnostic_bbox_reg:
            ...
            gt_class_cols = box_dim * self.gt_classes[fg_inds, None] + torch.arange(box_dim, device=device)
