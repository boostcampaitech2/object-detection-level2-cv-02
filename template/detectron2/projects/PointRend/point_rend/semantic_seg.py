...
class PointRendSemSegHead(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        self.coarse_sem_seg_head = SEM_SEG_HEADS_REGISTRY.get(cfg.MODEL.POINT_HEAD.COARSE_SEM_SEG_HEAD_NAME)(
            cfg, input_shape
        )
    ...
    def forward(self, features, targets=None):
        ...
        if self.training:
            ...
            for _ in range(self.subdivision_steps):
                ...
                sem_seg_logits = (
                    sem_seg_logits.reshape(N, C, H * W).scatter_(2, point_indices, point_logits).view(N, C, H, W)
                )
